...
public class WeChatErrorCode {
	...
	static{
		...
		ERRORCODE.put(40012,"不合法的缩略图文件大�?");
		...
		ERRORCODE.put(40021,"不合法的菜单版本�?");
		ERRORCODE.put(40022,"不合法的子菜单级�?");
		ERRORCODE.put(40023,"不合法的子菜单按钮个�?");
		ERRORCODE.put(40024,"不合法的子菜单按钮类�?");
		ERRORCODE.put(40025,"不合法的子菜单按钮名字长�?");
		ERRORCODE.put(40026,"不合法的子菜单按钮KEY长度");
		ERRORCODE.put(40027,"不合法的子菜单按钮URL长度");
		ERRORCODE.put(40028,"不合法的自定义菜单使用用�?");
		...
		ERRORCODE.put(41005,"缺少多媒体文件数�?");
		ERRORCODE.put(41006,"缺少media_id参数");
		ERRORCODE.put(41007,"缺少子菜单数�?");
		...
		ERRORCODE.put(43001,"�?要GET请求");
		ERRORCODE.put(43002,"�?要POST请求");
		ERRORCODE.put(43003,"�?要HTTPS请求");
		ERRORCODE.put(43004,"�?要接收�?�关�?");
		ERRORCODE.put(43005,"�?要好友关�?");
		ERRORCODE.put(44001,"多媒体文件为�?");
		ERRORCODE.put(44002,"POST的数据包为空");
		ERRORCODE.put(44003,"图文消息内容为空");
		ERRORCODE.put(44004,"文本消息内容为空");
		ERRORCODE.put(45001,"多媒体文件大小超过限�?");
