...
import com.cqgVipShare.util.wxpay.sdk.WXPayConstants.SignType;
...
public class WXPayUtil {
    ...
    /**
     * 鐢熸垚绛惧悕. 娉ㄦ剰锛岃嫢鍚湁sign_type瀛楁锛屽繀椤诲拰signType鍙傛暟淇濇寔涓�鑷淬��
     *
     * @param data 寰呯鍚嶆暟鎹�
     * @param key API瀵嗛�?
     * @param signType 绛惧悕鏂瑰紡
